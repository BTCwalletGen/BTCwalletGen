            ...
            <Footer>
                ...
                >
                    <Col className="firstSection" lg={8} md={12} sm={24}>
                        <img className="logo2" src={Logo2} alt="BTCwalletGen logo" />
                    ...
                    <Col className="secondSection" lg={8} md={12} sm={24}>
                        ...
                        <AhrefButton href="https://changelly.com/?ref_id=d48953617c7f" size="small" target="_blank" rel="noopener noreferrer">Swap coins instantly via Changelly.com</AhrefButton>

                        <p>Buy a...</p>
                        <AhrefButton href="https://www.ledgerwallet.com/r/87c4" size="small" target="_blank" rel="noopener noreferrer">Ledger Wallet</AhrefButton>
                        <AhrefButton href="https://trezor.io/?a=CPQ298A32HTH" size="small" target="_blank" rel="noopener noreferrer">TREZOR</AhrefButton>
                        ...
                        <div className="donations">
                            ...
                            <p className="donation-address">BTC:&nbsp;
                                <a href="https://blockexplorer.com/address/1Enm2854CJonJ4J6t4uBxQvbMb4Ryze2JT" target="_blank" rel="noopener noreferrer">1Enm2854CJonJ4J6t4uBxQvbMb4Ryze2JT</a>
                            </p>

                            <p className="donation-address">ETH:&nbsp;
                                <a href="https://etherscan.io/address/0xf1883f5541f6Ea4C83f64EA5F74b73fA629eB503" target="_blank" rel="noopener noreferrer">0xf1883f5541f6Ea4C83f64EA5F74b73fA629eB503</a>
                            </p>
                        </div>
                    </Col>

                    <Col className="thirdSection" lg={8} md={12} sm={24}>
                        <a href="https://btcwalletgen.com">BTCwalletGen.com</a>
                        <a href="mailto:contact@btcwalletgen.com">Contact us</a>
                        <a className="social" href="https://www.reddit.com/r/BTCwalletGen/" target="_blank" rel="noopener noreferrer">
                        ...
                        <a className="social" href="https://www.facebook.com/BTCwalletGen" target="_blank" rel="noopener noreferrer"><Icon type="facebook" /></a>
                        {/* <a className="social" href=""><Icon type="medium" /></a> */}
                        <a className="social" href="https://github.com/BTCwalletGen/BTCwalletGen" target="_blank" rel="noopener noreferrer"><Icon type="github" /></a>
                        <p>version 0.1.0</p>
                    </Col>
                </Row>
            </Footer>
